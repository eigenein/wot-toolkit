...
def main(args):
    ...
    json.dump({tanks[str(value["tank_id"])]: (value["statistics"]["wins"] / value["statistics"]["battles"]) for value in data if value["statistics"]["battles"] >= 25}, args.output, indent=2)
